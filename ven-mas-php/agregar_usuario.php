...
<div class="container">
    ...
    <form method="post">
        <div class="mb-3">
            ...
            <input type="text" name="usuario" class="form-control" id="usuario" placeholder="Escribe el nombre de usuario. Ej. paula">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="direccion" class="form-control" id="direccion" placeholder="Ej. Auto Norte 127 ">
        </div>
